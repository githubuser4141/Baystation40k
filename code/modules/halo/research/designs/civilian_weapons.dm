/datum/research_design/taser_pistol
	...
	required_reagents = list(/datum/reagent/phoron = 5, /datum/reagent/radium = 10)
	complexity = 5

/datum/research_design/taser_carbine
	...
	required_reagents = list(/datum/reagent/phoron = 10, /datum/reagent/radium = 15)
	complexity = 10
...
/datum/research_design/laser_carbine
	...
	required_reagents = list(/datum/reagent/phoron = 10, /datum/reagent/radium = 20)
	complexity = 10
