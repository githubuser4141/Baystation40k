...
/mob/proc/update_Login_details()
	...
	if(config.log_access)
		...
		if(is_multikeying && !client.warned_about_multikeying)
			...
			spawn(1 SECOND)
				to_chat(src, "<b>WARNING:</b> It would seem that you are sharing connection or cogitator with another player. If you haven't done so already, please contact the staff via the Adminhelp verb to resolve this situation. Failure to do so may result in administrative action. You have been warned.")
