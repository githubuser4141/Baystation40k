	...
	for(var/i=0,i<chunk_size,i++)
		for(var/j=0,j<chunk_size,j++)
			...
			if(tmp_cell < rare_val)      // Surface metals.
				...
				T.resources[MATERIAL_CERAMITE] =   0
				...
				T.resources[MATERIAL_CERAMITE] =   rand(RESOURCE_MID_MIN,  RESOURCE_MID_MAX)
				...
				T.resources[MATERIAL_CERAMITE] =   rand(RESOURCE_HIGH_MIN, RESOURCE_HIGH_MAX)
