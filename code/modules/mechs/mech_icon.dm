...
/mob/living/exosuit/on_update_icon()
	...
	if(body)
		...
		//new_overlays += get_mech_image(body.decal, "[body.icon_state][hatch_closed ? (body.total_damage == body.max_damage ? "_broken" : "_overlay") : "_overlay_open"]", body.on_mech_icon, body.color, MECH_COCKPIT_LAYER)
	if(arms)
