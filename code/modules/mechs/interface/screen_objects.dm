...
/obj/screen/exosuit/hardpoint/power
	name = "power hardpoint"
	icon_state = "hardpoint_p"
	interact_flags = null

/obj/screen/exosuit/hardpoint/power/Click(location, control, params)
	if(!..())
		return
...
/obj/screen/exosuit/hardpoint/power/update_system_info()
	..()
	var/obj/item/mech_equipment/power_stuff = owner.hardpoints[hardpoint_tag]
