/obj/structure/ship_munition/disperser_charge
	...
	desc = "A charge to power the macrocannon with. It looks impossibly round and shiny. This charge does not have a defined purpose."
	icon_state = "slug"
...
/obj/structure/ship_munition/disperser_charge/proc/fire(turf/target, strength, range)
	CRASH("Macrocannon charge firing logic not set!")

/obj/structure/ship_munition/disperser_charge/fire
	name = "\improper FR1-ENFER charge"
	color = "#b95a00"
	desc = "A charge to power the macrocannon with. It looks impossibly round and shiny. This charge is designed to release a localised fire on impact."
...
/obj/structure/ship_munition/disperser_charge/emp
	...
	color = "#6a97b0"
	desc = "A charge to power the macrocannon with. It looks impossibly round and shiny. This charge is designed to release a blast of electromagnetic pulse on impact."
...
/obj/structure/ship_munition/disperser_charge/mining
	...
	color = "#cfcf55"
	desc = "A charge to power the macrocannon with. It looks impossibly round and shiny. This charge is designed to mine ores on impact."
...
/obj/structure/ship_munition/disperser_charge/explosive
	...
	color = "#aa5f61"
	desc = "A charge to power the macrocannon with. It looks impossibly round and shiny. This charge is designed to explode on impact."
