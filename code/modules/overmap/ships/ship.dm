...
/obj/overmap/visitable/ship
	...
	var/min_speed = 1/(20 SECONDS)       // Below this, we round speed to 0 to avoid math errors.
	var/max_autopilot = 1 / (5 SECONDS) // The maximum speed any attached helm can try to autopilot at.
