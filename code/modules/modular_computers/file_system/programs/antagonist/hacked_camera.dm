/datum/computer_file/program/camera_monitor/hacked
	...
	extended_desc = "This very advanced piece of software uses adaptive programming and large database of cipherkeys to bypass most encryptions used on camera networks. Be warned that local mechanicum may notice this."
