/datum/computer_file/program/access_decrypter
	...
	extended_desc = "This highly advanced script can very slowly decrypt operational codes used in almost any network. These codes can be downloaded to an ID card to expand the available access. The local mechanicum will probably notice this."
	size = 34
	requires_ntnet = TRUE
