...
#define ASSIGNMENT_AI "Machine Spirit"
...
/datum/event_container/moderate
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Rogue Drones",							/datum/event/mob_spawning/rogue_drones, 20,		list(ASSIGNMENT_SECURITY = 20)),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Volkite Power Surge",				/datum/event/power_surge,				100,	list(ASSIGNMENT_ENGINEER = 10)),
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Warp Drive Instability",			/datum/event/bsd_instability,			50),
	)
...
/datum/event_container/major
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Warp Drive Instability",		/datum/event/bsd_instability,		0,		null, 1),
...
/datum/event_container/exo
	...
	available_events = list(
		new /datum/event_meta(EVENT_LEVEL_EXO, "Nothing",							/datum/event/nothing,				1320),
