...
/obj/item/stock_parts/circuitboard/kinetic_harvester
	...
	board_type = "machine"
	origin_tech = list(TECH_DATA = 3, TECH_ENGINEERING = 3, TECH_MATERIAL = 3)
	req_components = list(
...
/obj/item/stock_parts/circuitboard/fusion_fuel_compressor
	...
	board_type = "machine"
	origin_tech = list(TECH_POWER = 3, TECH_ENGINEERING = 3, TECH_MATERIAL = 3)
	req_components = list(
							/obj/item/stock_parts/manipulator/pico = 2,
...
/obj/item/stock_parts/circuitboard/fusion_core
	...
	board_type = "machine"
	origin_tech = list(TECH_BLUESPACE = 2, TECH_MAGNET = 3, TECH_POWER = 3)
	req_components = list(
							/obj/item/stock_parts/manipulator/pico = 2,
