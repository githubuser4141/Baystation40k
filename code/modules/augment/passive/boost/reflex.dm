/obj/item/organ/internal/augment/boost/reflex
	...
	desc = "A miniature cogitator with a primitive AI, this piece of engineering uses predictive algorithms and machine learning to provide near-instant response to any close combat situation."
