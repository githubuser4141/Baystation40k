/singleton/cultural_info/religion/unathi
	...
	description = "A faith of farmers, it is preached by semi-nomadic travelers who believe the destruction of Moghes is meant to be a chance for the kroot to \
...
/singleton/cultural_info/religion/unathi_precursors
	...
	description = "Focused primarily with learning and understanding everything they can about the precursors, kroot of this faith \
...
/singleton/cultural_info/religion/unathi_strat
	...
	How else will the kroot defeat the cosmic evil and survive in a world like Moghes?"
...
/singleton/cultural_info/religion/unathi_lights
	...
	the followers of the Lights believe in the knowledge of natural laws and hold that it should be kroot ingenuity and \
...
/singleton/cultural_info/religion/unathi_markesh
	...
	description = "The scorned Cult of Markesh stands apart from other kroot beliefs. Having first been mentioned and subsequently nearly \
	wiped two millennia later, other kroot view Markesheli as a dark spot in their history. A cult that thrived on violence and sacrifice, \
	...
	followers. However, most kroot still see them as a evil entity, in part due to their history of violence."

/singleton/cultural_info/religion/unathi_ancestor
	name = RELIGION_UNATHI_ANCESTOR
	description = "In order to ensure the normal functioning of natural and societal life, Kroot seek patronage with the powerful spirits of the \
	past, especially with those of their own kin, whom the call the Ancestors - the ranks of which every kroot is bound to join at some point. \
