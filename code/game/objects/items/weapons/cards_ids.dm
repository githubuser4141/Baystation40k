...
// ALL RINGS AND ID'S BELOW THIS LINE DO NOT HAVE CORRECT ACCESSES. IF YOU USE THEM WITHOUT SETTING AN ACCESS THEY WILL BE USELESS AND WONT OPEN ANY DOORS.
