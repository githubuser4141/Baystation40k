...
/obj/item/toy/torchmodel
	name = "table-top Dauntless model"
	desc = "This is a replica of the Dauntless, in 1:250th scale, on a handsome wooden stand. Small lights blink on the hull and at the engine exhaust."
	icon = 'icons/obj/toy.dmi'
