/obj/structure/coatrack
	...
	var/list/allowed = list(/obj/item/clothing/suit/armor/grim/toggle/labcoat, /obj/item/clothing/suit/armor/grim/storage/det_trench)
...
/obj/structure/coatrack/on_update_icon()
	ClearOverlays()
	if (istype(coat, /obj/item/clothing/suit/armor/grim/toggle/labcoat))
		AddOverlays(image(icon, icon_state = "coat_lab"))
	if (istype(coat, /obj/item/clothing/suit/armor/grim/toggle/labcoat/cmo))
		AddOverlays(image(icon, icon_state = "coat_cmo"))
	if (istype(coat, /obj/item/clothing/suit/armor/grim/storage/det_trench))
