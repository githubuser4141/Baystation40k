...
/datum/construction/mecha/hrunting_chassis
	steps = list(list("key"=/obj/item/mecha_parts/part/hrunting_torso),//1
					 list("key"=/obj/item/mecha_parts/part/hrunting_left_arm),//2
					 list("key"=/obj/item/mecha_parts/part/hrunting_right_arm),//3
					 list("key"=/obj/item/mecha_parts/part/hrunting_left_leg),//4
					 list("key"=/obj/item/mecha_parts/part/hrunting_right_leg),//5
					 list("key"=/obj/item/mecha_parts/part/hrunting_head)
					)
	...
	spawn_result()
		var/obj/item/mecha_parts/chassis/const_holder = holder
		const_holder.construct = new /datum/construction/reversible/mecha/hrunting(const_holder)
		const_holder.icon = 'icons/mecha/mech_construction.dmi'
		const_holder.icon_state = "gygax0"
		const_holder.set_density(1)
		spawn()
...
/datum/construction/reversible/mecha/hrunting
	result = /obj/mecha/combat/hrunting
	steps = list(
					//1
					list("key"=/obj/item/weapon/weldingtool,
							"backkey"=/obj/item/weapon/wrench,
					 ...
					 list("key"=/obj/item/weapon/wrench,
					 		...
					 		"desc"="External armor is installed."),
					 //3
					 list("key"=/obj/item/mecha_parts/part/hrunting_armour,
					 		"backkey"=/obj/item/weapon/weldingtool,
					 		"desc"="Internal armor is welded."),
					 //4
					 list("key"=/obj/item/weapon/weldingtool,
					 ...
					 list("key"=/obj/item/weapon/screwdriver,
					 		...
					 		"desc"="Targeting module is installed"),
					 //12
					 list("key"=/obj/item/weapon/circuitboard/mecha/hrunting/targeting,
					 		"backkey"=/obj/item/weapon/screwdriver,
					 		"desc"="Peripherals control module is secured"),
					 //13
					 list("key"=/obj/item/weapon/screwdriver,
					 		...
					 		"desc"="Peripherals control module is installed"),
					 //14
					 list("key"=/obj/item/weapon/circuitboard/mecha/hrunting/peripherals,
					 		"backkey"=/obj/item/weapon/screwdriver,
					 		"desc"="Central control module is secured"),
					 //15
					 list("key"=/obj/item/weapon/screwdriver,
					 		...
					 		"desc"="Central control module is installed"),
					 //16
					 list("key"=/obj/item/weapon/circuitboard/mecha/hrunting/main,
					 		"backkey"=/obj/item/weapon/screwdriver,
					 		"desc"="The wiring is adjusted"),
					 //17
					 list("key"=/obj/item/weapon/wirecutters,
		...
		switch(index)
			...
			if(15)
				if(diff==FORWARD)
					...
					user.visible_message("[user] removes the central control module from [holder].", "You remove the central computer mainboard from [holder].")
					new /obj/item/weapon/circuitboard/mecha/hrunting/main(get_turf(holder))
					holder.icon_state = "gygax4"
			if(14)
				if(diff==FORWARD)
					user.visible_message("[user] installs the peripherals control module into [holder].", "You install the peripherals control module into [holder].")
			...
			if(13)
				if(diff==FORWARD)
					...
					user.visible_message("[user] removes the peripherals control module from [holder].", "You remove the peripherals control module from [holder].")
					new /obj/item/weapon/circuitboard/mecha/hrunting/peripherals(get_turf(holder))
					holder.icon_state = "gygax6"
			if(12)
				if(diff==FORWARD)
					user.visible_message("[user] installs the weapon control module into [holder].", "You install the weapon control module into [holder].")
			...
			if(11)
				if(diff==FORWARD)
					...
					user.visible_message("[user] removes the weapon control module from [holder].", "You remove the weapon control module from [holder].")
					new /obj/item/weapon/circuitboard/mecha/hrunting/targeting(get_turf(holder))
					holder.icon_state = "gygax8"
			if(10)
				if(diff==FORWARD)
					user.visible_message("[user] installs advanced scanner module to [holder].", "You install advanced scanner module to [holder].")
			...
			if(3)
				if(diff==FORWARD)
					user.visible_message("[user] installs HRUNTING/YGGDRASIL Mark I ADS Armour Plates to [holder].", "You install HRUNTING/YGGDRASIL Mark I ADS Armour Plates to [holder].")
					qdel(used_atom)
					holder.icon_state = "gygax18"
				else
					user.visible_message("[user] cuts internal armor layer from [holder].", "You cut the internal armor layer from [holder].")
			...
			if(2)
				if(diff==FORWARD)
					user.visible_message("[user] secures HRUNTING/YGGDRASIL Mark I ADS Armour Plates.", "You secure HRUNTING/YGGDRASIL Mark I ADS Armour Plates.")
					holder.icon_state = "gygax19"
				else
					user.visible_message("[user] pries HRUNTING/YGGDRASIL Mark I ADS Armour Plates from [holder].", "You pry the  HRUNTING/YGGDRASIL Mark I ADS Armour Plates from [holder].")
					new /obj/item/mecha_parts/part/hrunting_armour(get_turf(holder))
					holder.icon_state = "gygax17"
			if(1)
				if(diff==FORWARD)
					user.visible_message("[user] welds HRUNTING/YGGDRASIL Mark I ADS Armour Plates to [holder].", "You weld HRUNTING/YGGDRASIL Mark I ADS Armour Plates to [holder].")
				else
					user.visible_message("[user] unfastens HRUNTING/YGGDRASIL Mark I ADS Armour Plates.", "You unfasten HRUNTING/YGGDRASIL Mark I ADS Armour Plates.")
					holder.icon_state = "gygax18"
		return 1
