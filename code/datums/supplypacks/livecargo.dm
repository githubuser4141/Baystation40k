...
/singleton/hierarchy/supply_pack/livecargo/monkey
...
/singleton/hierarchy/supply_pack/livecargo/corgi
	name = "Live - Corgi"
	contains = list()
	cost = 50
...
/singleton/hierarchy/supply_pack/livecargo/cat
	name = "Live - Cat"
	contains = list()
	cost = 50
...
/singleton/hierarchy/supply_pack/livecargo/cow
	name = "Live - Cow"
	cost = 80
