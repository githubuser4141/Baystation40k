...
/obj/item/folder/envelope/captain
	desc = "A thick envelope. The Imperial crest is stamped in the corner, along with 'TOP SECRET - TORCH UMBRA'."
...
/obj/item/folder/envelope/captain/LateInitialize(mapload)
	...
	None of these systems are claimed by any entity recognized by the Imperial, so you have full salvage rights on any derelicts discovered.<br>
	Investigate and mark any prospective colony worlds as per usual procedures.<br>
	There is no Imperial presence in that area. In case of distress calls, you will be the only vessel available; do not ignore them. We cannot afford any more PR backlash.<br>
	...
	<i>ADM Lau.</i></tt>
	<i>This paper has been stamped with the stamp of Imperial Expeditionary Command.</i>
	"}
...
/obj/item/paper/umbra
	...
	Procedure can be initiated only by transmission from Imperial Expeditionary Command via secure channel. The sender may not introduce themselves, but you shouldn't have trouble confirming the transmission source, I believe.<br>
	...
	<li>Information about this expedition's findings is to be treated as secret and vital to Imperial's national security, and is protected under codeword UMBRA. Only Imperial government employees and Skrell citizens aboard the Dauntless are allowed access to this information on a need-to-know basis.</li>
	...
	<i>Regards, John.</i></tt>
	<i>This paper has been stamped with the stamp of Office of the General Secretary of Imperial.</i>
	"}
